...
class ExtraneousLineFinder:
    ...
    def __init__(self, file, inputs, goals,
                 output='',
                 with_execute=False,
                 with_structure=False,
                 with_semantic=False):
        """:file:   path to the file to analyze
               :inputs: a list of input file names to be used with :file:
    ...
    def __enter__(self):
        ...
        for input_name in self.inputs:
            ...
            executed_lines = self._run_trace(input_name)
            ...
            if len(correct_lines) == 0:
                raise GoalNotFoundError("Correct output not found with input {}".format(input_name))
            ...
            print("Iteration <{}>".format(input_name))
